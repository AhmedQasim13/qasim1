...
function countresult(resultnumber) {
  ...
  if (correctprcnt < 50) {
    ...
    $(".result_msg").html(
      '<img src="~/images/cross.png" alt="cross"> You Failed!'
    );
    ...
    $(".result_msg").html(
      '<img src="~/images/warning.png" alt="warning"> Could have done better!'
    );
  } else if (correctprcnt >= 80) {
    ...
    $(".result_msg").html(
      '<img src="~/images/check.png" alt="check"> Wow! You are Brilliant!'
    );
  }
}
